...
# ╔═╡ 94151c04-55b1-11f1-942f-f9cb810c67f1
...
# ╔═╡ 9415205c-55b1-11f1-902f-613d05255539
...
# ╔═╡ 941521d6-55b1-11f1-bd9e-d92c2fb7f98a
md"""
...
# ╔═╡ 94152866-55b1-11f1-a005-57aafd2d6a58
md"""
...
# ╔═╡ 94152a3c-55b1-11f1-a0d7-a58f712b52d1
"""
...
# ╔═╡ 94152c08-55b1-11f1-a761-a3659652a744
begin
...
# ╔═╡ 941530ea-55b1-11f1-94bd-2166596060b5
md"""
...
# ╔═╡ 9415336a-55b1-11f1-b8c7-9978754fddd7
"""
...
# ╔═╡ 94153496-55b1-11f1-b5f3-e9a539409989
"""
...
# ╔═╡ 94153720-55b1-11f1-9e3c-f76107d0148d
begin
...
# ╔═╡ 9415444a-55b1-11f1-894a-216e78a70d62
...
# ╔═╡ 941544fe-55b1-11f1-a0c9-59cd01c5f7e4
"""Calcule le volume du domaine (m³)."""
volume(d::Domain) = d.Lx * d.Ly * d.Lz

# ╔═╡ 9415458c-55b1-11f1-b2ea-a3b515eff01b
begin
    d1 = Domain(2., 3., 4.)
...
# ╔═╡ 941548ee-55b1-11f1-a2ff-4f8dd4cc7843
"""
...
# ╔═╡ 94154b48-55b1-11f1-891a-fb4e768d6ddd
begin
...
# ╔═╡ 94155584-55b1-11f1-9ad6-a9f182d94774
begin
...
# ╔═╡ 94155714-55b1-11f1-8afa-0772a77e8a3c
...
# ╔═╡ 941558ea-55b1-11f1-8c6e-890163465575
begin
...
# ╔═╡ 94155ec6-55b1-11f1-a7da-67325821a3ce
...
# ╔═╡ 94155fb6-55b1-11f1-8c74-bbdfac5d5c9b
...
# ╔═╡ 94156116-55b1-11f1-aff6-5117cff6d43a
begin
...
# ╔═╡ 941562fe-55b1-11f1-94f5-555a9cbe41a9
begin
...
# ╔═╡ 941566e4-55b1-11f1-97ce-d5584d9c0d13
md"""
...
# ╔═╡ 94156830-55b1-11f1-a61d-53cc394c80a6
begin
...
# ╔═╡ 94156970-55b1-11f1-877a-69cd86d3b747
begin
    const N8      = 500
    const v0_8    = 1367.0
    const t_fin8  = 5e-11
...
# ╔═╡ 94156a74-55b1-11f1-8bb5-5b157ce24c47
begin
...
# ╔═╡ 94156c7c-55b1-11f1-abcc-65456ae97859
begin
...
# ╔═╡ 94156d6c-55b1-11f1-8c6f-05f5269b37f9
md"""
...
# ╔═╡ 94156fd8-55b1-11f1-832e-719bc8e98f4f
begin
...
# ╔═╡ 94157384-55b1-11f1-a290-a700039fb726
begin
...
# ╔═╡ 94157490-55b1-11f1-bed9-35feca926db3
begin
...
# ╔═╡ 9415769a-55b1-11f1-aa58-5da495def0d3
begin
...
# ╔═╡ 94157802-55b1-11f1-aab1-99228df5c485
md"""
...
# ╔═╡ 941579e2-55b1-11f1-994c-89644a086a9e
begin
    n_zb9  = 20
...
# ╔═╡ 94157ee2-55b1-11f1-bd75-0d89aff5c395
md"""
...
# ╔═╡ 94158068-55b1-11f1-8d0c-d3ef13c32d36
begin
...
# ╔═╡ 941583c4-55b1-11f1-afc5-95fcee4dbdd0
md"""
...
# ╔═╡ 941589e8-55b1-11f1-ab7a-9941e581861b
"""
...
# ╔═╡ 94158bbc-55b1-11f1-a0ee-7b405ddb7669
begin
    const L12    = 5e-9
    const N12    = 400
    const v0_12  = 1400.0
...
# ╔═╡ 94158c20-55b1-11f1-be0c-9d7c3f450803
begin
...
# ╔═╡ 94158dc4-55b1-11f1-b4fb-033be495f533
begin
...
# ╔═╡ 94158e5a-55b1-11f1-b52e-11e703c4ef46
begin
...
# ╔═╡ 9415906c-55b1-11f1-9708-7df75468edc9
md"""
## Q12.2 — Observations
...
manifest_format = "2.0"
project_hash = "06b795a25ff7f0f596a697d19bdd940bcba16f40"
